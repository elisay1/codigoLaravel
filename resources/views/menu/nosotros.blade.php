...
<title>@yield('title', 'Nosotros')</title>
@section('contenido')
    <main id="main" class="">
        ...
        <div class="breadcrumbs">
            <div class="page-header d-flex align-items-center"
                style="background-image: url('https://images.theconversation.com/files/130217/original/image-20160712-9264-zt66ib.jpg?ixlib=rb-4.1.0&q=45&auto=format&w=1356&h=668&fit=crop');">
                <div class="container position-relative">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h2 class="bg-warning rounded-2">@yield('title', 'Nosotros')</h2>
                        </div>
                    </div>
                </div>
            </div>
